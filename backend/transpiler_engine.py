...
# -*- coding: utf-8 -*-
"""
MINECRAFT TRANSPILER ENGINE v4.0 FINAL
=======================================
Conversão Java → Bedrock com items e blocos 100% visíveis

CORREÇÕES IMPLEMENTADAS:
✅ resource_pack/items/ OBRIGATÓRIO
✅ item_texture.json com atlas correto
✅ terrain_texture.json para blocos
✅ blocks.json na raiz do RP
✅ Dependencies UUID do HEADER
✅ Pastas plurais (items/ e blocks/)
"""
...
class Generator:
    ...
    def run(self, a: Analyzer):
        ...
        self._save({
            ...
            # ✅ CRÍTICO: Dependencies usa UUID do HEADER do RP
        ...
        for n, i in a.items.items():
            self._save({
                ...
                "minecraft:item": {
                    ...
                    "components": {
                        "minecraft:icon": i.tex,  # ✅ STRING simples
        ...
        # ✅ OBRIGATÓRIO: Items no RP (PONTE DE REGISTRO)
        print(f"   📝 Criando {len(a.items)} items no Resource Pack...")
        for n, i in a.items.items():
            self._save({
                "format_version": "1.20.80",
                "minecraft:item": {
                    ...
                    "components": {
                        "minecraft:icon": i.tex  # ✅ Nome no atlas
                    }
                }
        ...
        # ✅ item_texture.json (atlas de items)
        self._save({
        ...
        # ✅ terrain_texture.json (atlas de blocos)
        if a.blocks:
            self._save({
                "resource_pack_name": self.mod,
        ...
        print("✅ Items e blocos devem estar VISÍVEIS no jogo!")
